...
2.1.sec={Convert.EquityFinancing.sec}

Convert.EquityFinancing.=[G/SeriesSeed-Cooley-CmA/Sec/Conversion/QualifiedFinancing/0.md]

//=For the automating cross-referencing:

Convert.Xnum=2

Convert.EquityFinancing.Xnum={Convert.Xnum}.1
